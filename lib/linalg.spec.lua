return function()
    ...
    it("should handle arithmetic on rows correctly", function()
        ...
        expect(function() _ = mat[1] + 1 end).to.throw()
        expect(function() _ = mat[1] + v[1] end).to.throw()
        ...
        expect(function() _ = 2 ^ mat[1] end).to.throw()
        expect(function() _ = mat[1] ^ 2 end).to.throw()
        expect(function() _ = v[2] ^ mat[1] end).to.throw()
        expect(function() _ = mat[1] ^ v[2] end).to.throw()
        expect(function() _ = mat[1] ^ mat[1] end).to.throw()
    end)
    ...
    it("should handle basic matrix operations correctly", function()
        ...
        expect(function() local _v = mat2x3.Unit end).to.throw()
